# Instalace LexisEditor (nepodepsaná beta verze)
...
1. Ve složce Aplikace klikni na LexisEditor **pravým tlačítkem** (nebo Ctrl+klik).
2. Zvol **Otevřít**.
...
```bash
xattr -dr com.apple.quarantine "/Applications/LexisEditor.app"
```
