...
## ✨ Klíčové vlastnosti v2.1.0 (Enterprise Ready)

### 🤖 1. LexisAI: Právní mozek v editoru
- **Hloubková kontrola (Audit)**: Linter v reálném čase detekuje terminologické chyby, logické rozpory a špatné citace zákonů.
- **AI Tabs**: Vyhrazený prostor pro Chat, Právní rešerši a Sumarizaci dokumentů.
- **LexisLink Remote**: Ovládejte AI Agenta mobilem přes QR kód – diktujte příkazy nebo žádejte o shrnutí na dálku.

### 🔌 2. Profesionální integrace a Registry
- **ARES Real-time**: Okamžité načítání subjektů podle IČO.
- **ISDS Bridge**: Příjem a odesílání datových zpráv (.zfo) přímo z editoru. Automatická extrakce příloh.
- **Česká pošta (Dopis Online)**: Odesílání fyzických dopisů jedním kliknutím bez nutnosti chodit na pobočku.

### 🔐 3. Security & Privacy (v3.0 Core)
