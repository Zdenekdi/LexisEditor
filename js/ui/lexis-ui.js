...
<dmMessage>
    ...
    _updateCampaignRecordsPreview() {
        ...
        if (records.length === 0) {
            preview.innerHTML = eIco('<div style="font-size:12px;color:#94a3b8;padding:8px;">Žádné záznamy.</div>');
            return;
        }
    ...
    async renderContactsList() {
        ...
        tbody.innerHTML = eIco(`<tr><td colspan="6" style="padding:30px;text-align:center;color:#94a3b8;">⏳ Načítám...</td></tr>`);
        ...
        if (filtered.length === 0) {
            tbody.innerHTML = eIco(`<tr><td colspan="6" style="padding:40px;text-align:center;color:#94a3b8;font-size:13px;">
